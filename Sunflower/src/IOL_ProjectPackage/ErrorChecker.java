/*
This class was created by Latoza. 
Code testing by Tierra, debugging by Latoza.
...
This class is responsible for the Error checking. It is composed of:
    1. stringArr - checks if code starts and ends with IOL and LOI
    2. characterChecker - checks if word follows naming format
    3. isNumeric
    4. matchTypes - checks if current word matches keywords
    5. evalExpr - evaluates if arithmetic operation follows semantic rules
    6. getErrors - checks code for semantical, syntactical, and lexical errors
*/
