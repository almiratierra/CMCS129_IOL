/*
This class is created by Tierra.
Testing and debugging by Tierra.
This file is the main class of the project. It calls the classes: ExecuteFunctions and ErrorChecker.
Creates the GUI of the program and executes the action performed of each menu command.
Also contains Tokenizer (by Portillo) and TknToFile method for tokenizing of code.
 */
...
class IOL_GUI extends javax.swing.JFrame{
    ...
    ImageIcon icon = new ImageIcon(IOL_GUI.class.getResource("icon.png"));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(TokenizerTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void CompileMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CompileMenuItemActionPerformed
        ...
        */
        ...
        ConsoleTxtArea.setText(""); compileFlag = false;
    ...
    private void ExecuteMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExecuteMenuItemActionPerformed
        ...
        if(compileFlag == false){
            JOptionPane.showMessageDialog(null, "Cannot execute, compile code or resolve errors first.");
            return;
        }
    ...
    private void TokenizedMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TokenizedMenuItemActionPerformed
        ...
        String[] readLines = readTextArea();
        if(readLines == null){
            JOptionPane.showMessageDialog(null, "Nothing to tokenize.");
            return;
        }
        ...
        TknzdCode.setIconImage(icon.getImage());
