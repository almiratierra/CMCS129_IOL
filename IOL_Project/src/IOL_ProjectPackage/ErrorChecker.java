...
//                    System.exit(0);//terminates program
                ...
                else if(i == words.length-1 && !words[i].equals("LOI")){
                    System.out.println("Error! End of code not found.");
//                    System.exit(0);//terminates program
                }
                stack.push(words[i]);
                i++;
...
//                System.exit(0);
    ...
    public static void evalExpr(Stack<String> expr, List<String> varNames, List<String> operations){
        String var;
        int z = 0, d = 0;
...
//                            System.exit(0);
    ...
    public static Stack<String> getTokens(String strs, List<String> varNames, List<String> operations){
                                ...
                                if(varNames.contains(tokens.get(ctr+1))){
                                    if(operations.contains(tokens.get(ctr+3))){
                                        try{
                                            ...
                                            evalExpr(expression, varNames, operations);
                                        }catch(ArrayIndexOutOfBoundsException e){
