...
2 major functions:
    1. CheckDataType (static void) - responsible for checking and storing variables with data types (INT, STR)
    2. ProgramOperations (static String) - responsible for doing the actions that corresponds to the keyword (Assignment, input, output operations)
    3. isOPR (static String)
    4. evaluatePrefix (static Integer)
*/
